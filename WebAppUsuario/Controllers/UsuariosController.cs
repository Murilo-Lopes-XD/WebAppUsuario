...
namespace WebAppUsuario.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(WebAppUsuarioContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.UsuarioModel != null ? 
                          ...
                          Problem("Entity set 'WebAppUsuarioContext.UsuarioModel'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,email,Senha,Administrador,Ativo,DatadoCadastro,DatadoInativacao")] UsuarioModel usuarioModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,email,Senha,Administrador,Ativo,DatadoCadastro,DatadoInativacao")] UsuarioModel usuarioModel)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebAppUsuarioContext.UsuarioModel'  is null.");
            }
            var usuarioModel = await _context.UsuarioModel.FindAsync(id);
            if (usuarioModel != null)
            {
